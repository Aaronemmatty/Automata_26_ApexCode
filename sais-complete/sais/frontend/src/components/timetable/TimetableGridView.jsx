...
export default function TimetableGridView({ entries }) {
  ...
  return (
    <div className="bg-slate-900/50 backdrop-blur-md border border-slate-800/50 rounded-2xl p-4 lg:p-6 overflow-x-auto">
      <div
      ...
      >
        ...
        {entriesByDay.map((dayEntries, dayIndex) =>
          dayEntries.map((entry) => (
            ...
            >
              <div className="h-full p-2 rounded-lg bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm border border-slate-700/40 border-l-4 border-l-amber-400 hover:border-l-amber-300 transition-all hover:shadow-lg hover:shadow-amber-400/20">
